...
class ImageUploader
{
    const DEFAULT_BASE_TMP_PATH = 'sokoley/tmp';
    const DEFAULT_BASE_PATH = 'sokoley';
    ...
    {
        return rtrim($this->basePath . DIRECTORY_SEPARATOR . $this->mediaPath, DIRECTORY_SEPARATOR);
    }
    ...
    public function saveFileToTmpDir($fileId): array
    {
        ...
        $uploader->setAllowedExtensions($this::DEFAULT_ALLOWED_EXTENSIONS);
